    ...
    <div id="contact" className="w-screen px-10 my-20 min-h-96">
      <div className="relative py-24 bg-black rounded-lg text-blue-50 sm:overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="w-full mt-10 text-5xl special-font font-zentry leading-[0.9] md:text-[6rem]">Let`s b<b>u</b>ild the <br /> new era of <br /> g<b>a</b>ming t<b>o</b>gather</p>
